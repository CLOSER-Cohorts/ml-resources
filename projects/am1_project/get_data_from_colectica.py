...
colectica_utility.get_items_in_containing_items(project_config['Sweeps'],
    am1_data,
    "Summary",
...
for study in project_config['Sweeps']:
...
for study_agency_id in am1_data.keys():
    ...
    colectica_utility.get_categories_for_items(study_agency_id,
