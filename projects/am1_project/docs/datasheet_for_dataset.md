# Datasheet for dataset "Topic classification embeddings"
...
To enable automated topic classification of question/variable items

### Who created the dataset (e.g., which team, research group) and on behalf of which entity (e.g., company, institution, organization)?

Oliver Lyttleton, programmer in CLOSER Discovery Team. 
...
Metadata for questions and variables from UK longitudinal population studies

### How many instances are there in total (of each type, if appropriate)?

### Does the dataset contain all possible instances or is it a sample (not necessarily random) of instances from a larger set?

Some instances were filtered in pre-processing

### What data does each instance consist of? 

Text embeddings of question/variable labels and their associated multiple choice domains
(if available)

### Is there a label or target associated with each instance?

Yes, there are topics associated with each instance
...
Labels are currently manually assigned, they may occasionally be incorrect.

### Is the dataset self-contained, or does it link to or otherwise rely on external resources (e.g., websites, tweets, other datasets)?

The embeddings represent questions that are part of the CLOSER dataset,
...
It was provided by a UK longitudinal population study.

### What mechanisms or procedures were used to collect the data (e.g., hardware apparatus or sensor, manual human curation, software program, software API)?

Depends on the study, and the wave. See discovery.closer.ac.uk for info.
...
Yes, in response to performance metrics and data drift. Github notifications will
be sent.
