...
mlflow server  --app-name basic-auth --host 0.0.0.0 --port 5000 --allowed-hosts 127.0.0.1:5000,localhost:5000,HOSTNAME:19015 --cors-allowed-origins http://HOSTNAME:19015
